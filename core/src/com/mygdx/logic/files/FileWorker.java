...
public class FileWorker {
    ...
    public static void saveScore(String userName, String score, Date date) {
        ...
        fileHandle.writeString(userName + SPLIT + score + SPLIT + date + "\n", true);
    }

    public static List<String> getUsersResults() {
        return Arrays.asList(Gdx.files.local(RESULTS_FILE_PATH).readString().split("\n"));
    }
